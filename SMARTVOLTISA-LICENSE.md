...
This document establishes the provenance and authorship context of the SmartVoltISA body of work and defines principles for preserving that provenance when the work is copied, reused, modified, published, or incorporated into another project.

It supplements the applicable software or content license in this repository. It does not replace a third-party license and does not grant rights that the applicable license does not grant.

## 2. Origin and authorship

The SmartVoltISA body of work originated from a sustained human-led research and development process initiated and directed by **Alexander / SmartVoltISA**.

The work includes, among other things, concepts, hypotheses, architectural principles, protocols, experiments, software, documentation, models, research records, and derived systems developed over time.

**Human role:** setting goals and questions, defining meaning and constraints, directing the research, evaluating hypotheses, accepting or rejecting results, and making final decisions about the work.
...
- Proposed work is not the same as performed work.
- Performed work is not automatically confirmed work.
- Repair is not the same as historical recovery.
- A later formulation must not silently erase its earlier history.

## 4. Attribution and provenance preservation

Where this work or substantial portions of it are reused, the original authorship and provenance information should be preserved where technically and legally applicable.

Users and downstream projects must not knowingly present the original SmartVoltISA work, its historical origin, or its development lineage as having originated elsewhere.
...
Unless a repository or individual file states otherwise, software is governed by the applicable software license, including Apache-2.0 where designated.

Third-party materials remain subject to their original licenses.

This document is a provenance and authorship notice. It is not intended to replace the legal terms of the applicable copyright, patent, software, data, documentation, or third-party licenses.

## 8. Preservation statement

The objective is simple:

> **Leave a trace that can be checked.**
>
> **Do not require belief where evidence can be preserved.**
>
> **The scale of the result belongs to history to determine.**
